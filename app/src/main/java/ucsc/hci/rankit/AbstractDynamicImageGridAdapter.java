...
/**
 * Abstract adapter for {@link DynamicImageGridView} with sable items id;
 */

public abstract class AbstractDynamicImageGridAdapter extends BaseAdapter implements DynamicImageGridAdapterInterface {
