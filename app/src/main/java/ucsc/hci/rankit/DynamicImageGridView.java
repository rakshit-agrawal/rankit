...
public class DynamicImageGridView extends GridView {
    ...
    // change to by default is edit mode.
    ...
    // change to by default wobble mode is not on.
    ...
    public DynamicImageGridView(Context context, AttributeSet attrs, int defStyle) {
    ...
    /**
     * A {@link ucsc.hci.rankit.DynamicImageGridView.SwitchCellAnimator} for versions KitKat and below.
     */
    ...
    /**
     * A {@link ucsc.hci.rankit.DynamicImageGridView.SwitchCellAnimator} for versions L and above.
     */
